...
'redundancyArkyMSN':  0, # connection not defined
...
'redundancyArkyFSI':  8.88250626566,
...
'redundancyProtSTN':  20.645021645,
...
'redundancyCMPfArky': 9.02257636122,
'redundancySTNArky':  36.326002656,  # should be reduced to 32 when using scale=4
'redundancyMSNArky':  6006.11952191,
'redundancyArkyArky':  10.36,
'redundancyProtArky':  10.36,

'redundancyCMPfProt': 9.02257636122,
'redundancySTNProt':  36.326002656,  # should be reduced to 32 when using scale=4
'redundancyMSNProt':  6006.11952191,
'redundancyProtProt':  10.36,
'redundancyArkyProt':  10.36,

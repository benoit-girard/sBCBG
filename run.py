...
class JobDispatcher:
  ...
  def dispatch(self):
    ...
    self.files_to_transfer = ['LGneurons.py', 'iniBG.py', self.params['whichTest']+'.py', 'nstrand.py', 'solutions_simple_unique.csv', '__init__.py','spikeProcessing.py','filter.py']
...
def main():
    ...
    Optional.add_argument('--whichTest', type=str, help='Which test to run?', choices=['testPlausibility','testReactionToInput', 'testSelection', 'testPsychometrics','testGPR01', 'testGPR01Deact', 'testChannel', 'testChannelBG', 'testSelec', 'testSelec2D', 'testReaching', 'testDA', 'testPauses'], default=None)
